...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="Thrift Vibe">
    <meta name="msapplication-TileImage" content="{{asset('assets/images/favicon.ico')}}">
    <meta name="msapplication-TileColor" content="#FFFFFF">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="description" content="Thrift Vibe">
    <meta name="keywords" content="Thrift Vibe">
    <meta name="author" content="Thrift Vibe">
    <link rel="preconnect" href="https://fonts.gstatic.com">

    <title>Thrift Vibe</title>
                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{ route('app.index') }}">
                                        <img src="{{ asset('assets/images/logoNav.jpg') }}" class="h-logo img-fluid blur-up lazyload" alt="logo" style="width: 100px; height: auto;">
                                    </a>                                    
                                </div>
                            </div>
                            <nav>
                                    ...
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            @if(Auth::user()->utype === 'ADM')
                                                <li><a href="/admin/product" class="nav-link menu-title">Product</a></li>
                                            @endif
                                            @endauth
                                        </ul>
                                    </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light">+62456789765</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light">Malang, Pakis </span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> contact@ThriftVibe</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2023, Thrift Vibe</p>
                    </div>
                </div>
            </div>
        </div>
